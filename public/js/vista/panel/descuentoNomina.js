$(function() {
    ...
    var tablaRegistros = $('#tablaRegistros').DataTable({
        ...
        columns: window.innerWidth < 1024 ? [
            { data: 'nomina' },
            { data: 'prestamo', render: $.fn.dataTable.render.number(',', '.', 2, '') },
            { data: 'factura', render: $.fn.dataTable.render.number(',', '.', 2, '') },
            { data: 'aportes', render: $.fn.dataTable.render.number(',', '.', 2, '') },
            { data: 'ahorros', render: $.fn.dataTable.render.number(',', '.', 2, '') },
            ...
            buttons: [
                ...
                // Botón de imprimir
                {
                    ...
                    customize: function(tablaRegistros = $('#tablaRegistros')) {
                        ...
                        $(tablaRegistros.document.body)
                            .find('.prestamo, .factura, .aportes, .ahorros, .total')
                            .addClass('alinearDerecha');
        ...
        drawCallback: function() {
            ...
            let indicesColumnasSumar =
                window.innerWidth < 1024 ? [1, 2, 3, 4, 5] : [2, 3, 4, 5, 6];
        ...
        order: window.innerWidth < 992 ? [0, 'desc'] : [0, 'desc'],
