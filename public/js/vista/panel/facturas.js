    ...
    var tablaRegistros = $('#tablaRegistros').DataTable({
            ...
            buttons: [
                ...
                // Botón de imprimir
                {
                    ...
                    customize: function(tablaRegistros = $('#tablaRegistros')) {
                        ...
                        $(tablaRegistros.document.body)
                            .find('.factura, .descripcion, .fecha')
                            .addClass('alinearIzquierda');

                        $(tablaRegistros.document.body)
                            .find('.monto, .montoPagado, .balance')
                            .addClass('alinearDerecha');
        ...
        drawCallback: function() {
            ...
            let indicesColumnasSumar =
                window.innerWidth < 1024 ? [2, 3, 4] : [3, 4, 5];
                        ...
                        // Botón de imprimir
                        {
                            ...
                            customize: function(tablaRegistrosDialogo = $('#tablaRegistrosDialogo')) {
                                ...
                                $(tablaRegistrosDialogo.document.body)
                                    ...
                                    .after(`
                                    <tr class="report-header-cell contenedorTitulo">
                                    <th class="header-info titulo" colspan="100%">Pagos de Facturas</th>
                                    </tr>
                                `);
    ...
    if (window.innerWidth < 1024) {
        ...
        $('#tablaRegistros tbody').on('click', 'tr:has(>td:not([class="dataTables_empty"]))', function() {
            ...
            if ($(this).hasClass('seleccionada')) {
                ...
                factura = {
                    numero: $(this).find('.factura').text()
                };

                json.forEach(registro => {

                    if (registro.cuenta == factura.numero) {

                        factura.concepto = registro.descripcion;
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="row" style="align-items:center">
                                                <div class="col-12">
                                                    <div class="row">
                                                        <div class="col-3" style="padding-right:0">Documento:</div>
                                                        <div class="col-9" style="padding:0;text-align:right">
                                                            ${registro.documento}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="row">
                                                        <div class="col-3" style="padding-right:0">Concepto:</div>
                                                        <div class="col-9" style="padding:0;text-align:right">
                                                            ${registro.concepto}
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="row">
                                                        <div class="col-3" style="padding-right:0">Monto:</div>
                                                        <div class="col-9" style="padding:0;text-align:right">
                                                            ${textoFormatoNumerico([registro.monto], 2)}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
