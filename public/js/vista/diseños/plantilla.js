/*! For license information please see plantilla.js.LICENSE.txt */
(() => {
    var e, t = {
            1465: (e, t, n) => {
                "use strict";
            ...
            9044: (e, t, n) => {
                ...
                function s() { l(document.body.classList.contains("theme-dark") ? "theme-light" : "theme-dark") }
                ...
                r &&
                r.addEventListener("input", (function(e) { l(e.target.checked ? "theme-dark" : "theme-light") })), document.addEventListener("DOMContentLoaded", (function() { var e; if (r && console.log("Dark Loaded"), e = localStorage.getItem(i)) return l(e); if (window.matchMedia) { var t = window.matchMedia("(prefers-color-scheme: dark)"); return t.addEventListener("change", (function(e) { return l(e.matches ? "theme-dark" : "theme-light", !0) })), l(t.matches ? "theme-dark" : "theme-light", !0) } }))
            },
            7750: () => {
                                ...
                                for (var t = document.querySelectorAll(".sidebar-item.has-sub"), i = function() {
                                        ...
                                        t[o].querySelector(".sidebar-link").addEventListener("click", (function(t) {
                                            ...
                                            o.classList.contains("active") && (o.style.display = "block"), "none" == o.style.display ? o.classList.add("active") : o.classList.remove("active"),
                                                function(e, t, i) { 0 === e.clientHeight ? n(e, t, i, !0) : n(e, t, i) }(o, 300, (function() { return e.forceElementVisibility(i) }))
                                        }))
                                    }, o = 0; o < t.length; o++) i();
            ...
            7244: (e, t, n) => {
                "use strict";
                n.r(t), n.d(t, { Alert: () => bt, Button: () => xt, Carousel: () => It, Collapse: () => Ut, Dropdown: () => mn, Modal: () => Bn, Offcanvas: () => Gn, Popover: () => ji, ScrollSpy: () => Hi, Tab: () => Wi, Toast: () => Fi, Tooltip: () => bi });
                var i = {};
                n.r(i), n.d(i, { afterMain: () => j, afterRead: () => _, afterWrite: () => M, applyStyles: () => H, arrow: () => G, auto: () => a, basePlacements: () => c, beforeMain: () => x, beforeRead: () => v, beforeWrite: () => E, bottom: () => r, clippingParents: () => p, computeStyles: () => te, createPopper: () => Se, createPopperBase: () => Te, createPopperLite: () => Ce, detectOverflow: () => ge, end: () => h, eventListeners: () => ie, flip: () => ve, hide: () => xe, left: () => l, main: () => w, modifierPhases: () => k, offset: () => we, placements: () => g, popper: () => f, popperGenerator: () => Le, popperOffsets: () => je, preventOverflow: () => Ee, read: () => b, reference: () => m, right: () => s, start: () => d, top: () => o, variationPlacements: () => y, viewport: () => u, write: () => A });
                var o = "top",
                    r = "bottom",
                    s = "right",
                    l = "left",
                    ...
                    f = "popper",
                    m = "reference",
                    y = c.reduce((function(e, t) { return e.concat([t + "-" + d, t + "-" + h]) }), []),
                    g = [].concat(c, [a]).reduce((function(e, t) { return e.concat([t, t + "-" + d, t + "-" + h]) }), []),
                    v = "beforeRead",
                    b = "read",
                    _ = "afterRead",
                    x = "beforeMain",
                ...
                function L(e) { if (null == e) return window; if ("[object Window]" !== e.toString()) { var t = e.ownerDocument; return t && t.defaultView || window } return e }

                function T(e) { return e instanceof L(e).Element || e instanceof Element }

                function S(e) { return e instanceof L(e).HTMLElement || e instanceof HTMLElement }

                function C(e) { return "undefined" != typeof ShadowRoot && (e instanceof L(e).ShadowRoot || e instanceof ShadowRoot) }
                const H = {
                    name: "applyStyles",
                    enabled: !0,
                    phase: "write",
                    fn: function(e) {
                        ...
                        Object.keys(t.elements).forEach((function(e) {
                            var n = t.styles[e] || {},
                                i = t.attributes[e] || {},
                                o = t.elements[e];
                            S(o) && O(o) && (Object.assign(o.style, n), Object.keys(i).forEach((function(e) { var t = i[e];!1 === t ? o.removeAttribute(e) : o.setAttribute(e, !0 === t ? "" : t) })))
                        }))
                    },
                    effect: function(e) {
                        var t = e.state,
                        ...
                        return Object.assign(t.elements.popper.style, n.popper), t.styles = n, t.elements.arrow && Object.assign(t.elements.arrow.style, n.arrow),
                            function() {
                                Object.keys(t.elements).forEach((function(e) {
                                    ...
                                    S(i) && O(i) && (Object.assign(i.style, r), Object.keys(o).forEach((function(e) { i.removeAttribute(e) })))
                                }))
                            }
                    },
                ...
                function Y(e) { return L(e).getComputedStyle(e) }

                function V(e) { return ["table", "td", "th"].indexOf(O(e)) >= 0 }

                function X(e) { return ((T(e) ? e.ownerDocument : e.document) || window.document).documentElement }

                function B(e) { return "html" === O(e) ? e : e.assignedSlot || e.parentNode || (C(e) ? e.host : null) || X(e) }

                function q(e) { return S(e) && "fixed" !== Y(e).position ? e.offsetParent : null }
                ...
                function U(e, t, n) { return D(e, z(t, n)) }
                ...
                const G = {
                    ...
                    fn: function(e) {
                        ...
                        if (d && h) {
                            var m = function(e, t) { return K("number" != typeof(e = "function" == typeof e ? e(Object.assign({}, t.rects, { placement: t.placement })) : e) ? e : Q(e, c)) }(a.padding, n),
                                y = W(d),
                                g = "y" === u ? o : l,
                                v = "y" === u ? r : s,
                ...
                function ee(e) {
                    ...
                    var S, C = Object.assign({ position: p }, f && J),
                        H = !0 === m ? function(e) {
                            var t = e.x,
                                n = e.y,
                ...
                const ie = {
                    ...
                    effect: function(e) {
                        ...
                        return r && c.forEach((function(e) { e.addEventListener("scroll", n.update, ne) })), l && a.addEventListener("resize", n.update, ne),
                            function() { r && c.forEach((function(e) { e.removeEventListener("scroll", n.update, ne) })), l && a.removeEventListener("resize", n.update, ne) }
                    },
                    data: {}
                };
                ...
                function le(e) { return e.replace(/start|end/g, (function(e) { return se[e] })) }

                function ae(e) { var t = L(e); return { scrollLeft: t.pageXOffset, scrollTop: t.pageYOffset } }

                function ce(e) { return N(X(e)).left + ae(e).scrollLeft }
                ...
                function he(e) { return ["html", "body", "#document"].indexOf(O(e)) >= 0 ? e.ownerDocument.body : S(e) && de(e) ? e : he(B(e)) }
                ...
                function fe(e, t) {
                    ...
                    }(e)) : T(t) ? function(e) { var t = N(e); return t.top = t.top + e.clientTop, t.left = t.left + e.clientLeft, t.bottom = t.top + e.clientHeight, t.right = t.left + e.clientWidth, t.width = e.clientWidth, t.height = e.clientHeight, t.x = t.left, t.y = t.top, t }(t) : ue(function(e) {
                        var t, n = X(e),
                            i = ae(e),
                ...
                function me(e, t, n) {
                    var i = "clippingParents" === t ? function(e) {
                            ...
                            return T(n) ? t.filter((function(e) { return T(e) && R(e, n) && "body" !== O(e) })) : []
                        }(e) : [].concat(t),
                        o = [].concat(i, [n]),
                        r = o[0],
                        s = o.reduce((function(t, n) { var i = fe(e, n); return t.top = D(i.top, t.top), t.right = z(i.right, t.right), t.bottom = z(i.bottom, t.bottom), t.left = D(i.left, t.left), t }), fe(e, r));
                ...
                const ve = {
                    ...
                    fn: function(e) {
                        ...
                        if (!t.modifiersData[i]._skip) {
                            for (var h = n.mainAxis, p = void 0 === h || h, u = n.altAxis, f = void 0 === u || u, m = n.fallbackPlacements, v = n.padding, b = n.boundary, _ = n.rootBoundary, x = n.altBoundary, w = n.flipVariations, j = void 0 === w || w, E = n.allowedAutoPlacements, A = t.options.placement, M = P(A), k = m || (M === A || !j ? [re(A)] : function(e) { if (P(e) === a) return []; var t = re(e); return [le(e), t, le(t)] }(A)), O = [A].concat(k).reduce((function(e, n) {
                                    return e.concat(P(n) === a ? function(e, t) {
                                        ...
                                        var n = t,
                                            ...
                                            d = void 0 === a ? g : a,
                                            h = Z(i),
                                            p = h ? l ? y : y.filter((function(e) { return Z(e) === h })) : c,
                                            u = p.filter((function(e) { return d.indexOf(e) >= 0 }));
                                        0 === u.length && (u = p);
                                        var f = u.reduce((function(t, n) { return t[n] = ge(e, { placement: n, boundary: o, rootBoundary: r, padding: s })[P(n)], t }), {});
                                        return Object.keys(f).sort((function(e, t) { return f[e] - f[t] }))
                                    }(t, { placement: n, boundary: b, rootBoundary: _, padding: v, flipVariations: j, allowedAutoPlacements: E }) : n)
                                ...
                                var X = re(V),
                                    B = [];
                                if (p && B.push(Y[I] <= 0), f && B.push(Y[V] <= 0, Y[X] <= 0), B.every((function(e) { return e }))) { H = z, C = !1; break }
                                S.set(z, B)
                            }
                            if (C)
                                for (var q = function(e) { var t = O.find((function(t) { var n = S.get(t); if (n) return n.slice(0, e).every((function(e) { return e })) })); if (t) return H = t, "break" }, F = j ? 3 : 1; F > 0; F--) { if ("break" === q(F)) break }
                ...
                function _e(e) { return [o, s, r, l].some((function(t) { return e[t] >= 0 })) }
                const xe = {
                    name: "hide",
                    enabled: !0,
                    phase: "main",
                    ...
                    fn: function(e) {
                        var t = e.state,
                            ...
                            d = _e(a),
                            h = _e(c);
                        t.modifiersData[n] = { referenceClippingOffsets: a, popperEscapeOffsets: c, isReferenceHidden: d, hasPopperEscaped: h }, t.attributes.popper = Object.assign({}, t.attributes.popper, { "data-popper-reference-hidden": d, "data-popper-escaped": h })
                    }
                };
                const we = {
                    name: "offset",
                        ...
                        if (k) {
                            ...
                            if (p) {
                                var he, pe = "x" === A ? o : l,
                                    ...
                                    je = v && be ? function(e, t, n) { var i = U(e, t, n); return i > n ? n : i }(xe, fe, we) : U(v ? xe : ye, fe, v ? we : ve);
                                k[M] = je, H[M] = je - fe
                            }
                            t.modifiersData[i] = H
                        }
                ...
                function Ae(e, t, n) {
                    ...
                    var i, o, r = S(t),
                        ...
                        d = { x: 0, y: 0 };
                    return (r || !r && !n) && (("body" !== O(t) || de(l)) && (c = (i = t) !== L(i) && S(i) ? { scrollLeft: (o = i).scrollLeft, scrollTop: o.scrollTop } : ae(i)), S(t) ? ((d = N(t, !0)).x += t.clientLeft, d.y += t.clientTop) : l && (d.x = ce(l))), { x: a.left + c.scrollLeft - d.x, y: a.top + c.scrollTop - d.y, width: a.width, height: a.height }
                }
                ...
                function Oe() { for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++) t[n] = arguments[n]; return !t.some((function(e) { return !(e && "function" == typeof e.getBoundingClientRect) })) }
                ...
                function Le(e) {
                    ...
                    return function(e, t, n) {
                        void 0 === n && (n = r);
                        var o, s, l = { placement: "bottom", orderedModifiers: [], options: Object.assign({}, ke, r), modifiersData: {}, elements: { reference: e, popper: t }, attributes: {}, styles: {} },
                            a = [],
                            c = !1,
                            d = {
                                state: l,
                                setOptions: function(n) {
                                    ...
                                    var s = function(e) { var t = Me(e); return k.reduce((function(e, n) { return e.concat(t.filter((function(e) { return e.phase === n }))) }), []) }(function(e) { var t = e.reduce((function(e, t) { var n = e[t.name]; return e[t.name] = n ? Object.assign({}, n, t, { options: Object.assign({}, n.options, t.options), data: Object.assign({}, n.data, t.data) }) : t, e }), {}); return Object.keys(t).map((function(e) { return t[e] })) }([].concat(i, l.options.modifiers)));
                                    return l.orderedModifiers = s.filter((function(e) { return e.enabled })), l.orderedModifiers.forEach((function(e) {
                                        var t = e.name,
                                            n = e.options,
                                            i = void 0 === n ? {} : n,
                                            o = e.effect;
                                ...
                                forceUpdate: function() {
                                    if (!c) {
                                        var e = l.elements,
                                            ...
                                            n = e.popper;
                                        if (Oe(t, n)) {
                                            l.rects = { reference: Ae(t, F(n), "fixed" === l.options.strategy), popper: W(n) }, l.reset = !1, l.placement = l.options.placement, l.orderedModifiers.forEach((function(e) { return l.modifiersData[e.name] = Object.assign({}, e.data) }));
                                ...
                                update: (o = function() { return new Promise((function(e) { d.forceUpdate(), e(l) })) }, function() { return s || (s = new Promise((function(e) { Promise.resolve().then((function() { s = void 0, e(o()) })) }))), s }),
                                destroy: function() { h(), c = !0 }
                            };
                        if (!Oe(e, t)) return d;

                        function h() { a.forEach((function(e) { return e() })), a = [] }
                ...
                const He = "transitionend",
                    ...
                    De = e => { const t = Pe(e); return t && document.querySelector(t) ? t : null },
                    ze = e => { const t = Pe(e); return t ? document.querySelector(t) : null },
                    Ie = e => { e.dispatchEvent(new Event(He)) },
                    ...
                    Xe = e => { if (!document.documentElement.attachShadow) return null; if ("function" == typeof e.getRootNode) { const t = e.getRootNode(); return t instanceof ShadowRoot ? t : null } return e instanceof ShadowRoot ? e : e.parentNode ? Xe(e.parentNode) : null },
                    Be = () => {},
                    qe = e => { e.offsetHeight },
                    Fe = () => { const { jQuery: e } = window; return e && !document.body.hasAttribute("data-bs-no-jquery") ? e : null },
                    $e = [],
                    ...
                    Ke = e => {
                        ...
                        }, "loading" === document.readyState ? ($e.length || document.addEventListener("DOMContentLoaded", (() => { $e.forEach((e => e())) })), $e.push(t)) : t()
                    },
                    Qe = e => { "function" == typeof e && e() },
                    Ge = (e, t, n = !0) => {
                        ...
                        let o = !1;
                        const r = ({ target: n }) => { n === t && (o = !0, t.removeEventListener(He, r), Qe(e)) };
                        t.addEventListener(He, r), setTimeout((() => { o || Ie(t) }), i)
                    },
                    Ze = (e, t, n, i) => { let o = e.indexOf(t); if (-1 === o) return e[!n && i ? e.length - 1 : 0]; const r = e.length; return o += n ? 1 : -1, i && (o = (o + r) % r), e[Math.max(0, Math.min(o, r - 1))] },
                    Je = /[^.]*(?=\..*)\.|.*/,
                    et = /\..*/,
                    tt = /::\d+$/,
                    nt = {};
                ...
                function lt(e, t) { return t && `${t}::${it++}` || e.uidEvent || it++ }

                function at(e) { const t = lt(e); return e.uidEvent = t, nt[t] = nt[t] || {}, nt[t] }

                function ct(e, t, n = null) { const i = Object.keys(e); for (let o = 0, r = i.length; o < r; o++) { const r = e[i[o]]; if (r.originalHandler === t && r.delegationSelector === n) return r } return null }
                ...
                function ht(e, t, n, i, o) {
                    ...
                    const h = lt(s, t.replace(Je, "")),
                        ...
                        }(e, n, i) : function(e, t) { return function n(i) { return i.delegateTarget = e, n.oneOff && ft.off(e, i.type, t), t.apply(e, [i]) } }(e, n);
                ...
                function ut(e) { return e = e.replace(et, ""), ot[e] || e }
                const ft = {
                        on(e, t, n, i) { ht(e, t, n, i, !1) },
                        one(e, t, n, i) { ht(e, t, n, i, !0) },
                        off(e, t, n, i) {
                            if ("string" != typeof t || !e) return;
                            const [o, r, s] = dt(t, n, i), l = s !== t, a = at(e), c = t.startsWith(".");
                            if (void 0 !== r) { if (!a || !a[s]) return; return void pt(e, a, s, r, o ? n : null) }
                ...
                class gt {
                    ...
                    dispose() { yt.remove(this._element, this.constructor.DATA_KEY), ft.off(this._element, this.constructor.EVENT_KEY), Object.getOwnPropertyNames(this).forEach((e => { this[e] = null })) }
                    _queueCallback(e, t, n = !0) { Ge(e, t, n) }
                    static getInstance(e) { return yt.get(We(e), this.DATA_KEY) }
                ...
                class bt extends gt {
                    ...
                    _destroyElement() { this._element.remove(), ft.trigger(this._element, "closed.bs.alert"), this.dispose() }
                ...
                class xt extends gt {
                    ...
                    static jQueryInterface(e) { return this.each((function() { const t = xt.getOrCreateInstance(this); "toggle" === e && t[e]() })) }
                }

                function wt(e) { return "true" === e || "false" !== e && (e === Number(e).toString() ? Number(e) : "" === e || "null" === e ? null : e) }

                function jt(e) { return e.replace(/[A-Z]/g, (e => `-${e.toLowerCase()}`)) }
                ...
                const Et = {
                        setDataAttribute(e, t, n) { e.setAttribute(`data-bs-${jt(t)}`, n) },
                        removeDataAttribute(e, t) { e.removeAttribute(`data-bs-${jt(t)}`) },
                        getDataAttributes(e) {
                            if (!e) return {};
                            const t = {};
                    ...
                    At = {
                        ...
                        focusableChildren(e) { const t = ["a", "button", "input", "textarea", "select", "details", "[tabindex]", '[contenteditable="true"]'].map((e => `${e}:not([tabindex^="-"])`)).join(", "); return this.find(t, e).filter((e => !Ve(e) && Ye(e))) }
                    },
                    Mt = "carousel",
                ...
                class It extends gt {
                    constructor(e, t) { super(e), this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this.touchTimeout = null, this.touchStartX = 0, this.touchDeltaX = 0, this._config = this._getConfig(t), this._indicatorsElement = At.findOne(".carousel-indicators", this._element), this._touchSupported = "ontouchstart" in document.documentElement || navigator.maxTouchPoints > 0, this._pointerEvent = Boolean(window.PointerEvent), this._addEventListeners() }
                    static get Default() { return kt }
                    static get NAME() { return Mt }
                    next() { this._slide(Lt) }
                    nextWhenVisible() {!document.hidden && Ye(this._element) && this.next() }
                    prev() { this._slide(Tt) }
                    pause(e) { e || (this._isPaused = !0), At.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (Ie(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null }
                    ...
                    _getConfig(e) { return e = {...kt, ...Et.getDataAttributes(this._element), ... "object" == typeof e ? e : {} }, Re(Mt, e, Ot), e }
                    _handleSwipe() {
                    ...
                    _addEventListeners() { this._config.keyboard && ft.on(this._element, "keydown.bs.carousel", (e => this._keydown(e))), "hover" === this._config.pause && (ft.on(this._element, "mouseenter.bs.carousel", (e => this.pause(e))), ft.on(this._element, "mouseleave.bs.carousel", (e => this.cycle(e)))), this._config.touch && this._touchSupported && this._addTouchEventListeners() }
                    _addTouchEventListeners() {
                        const e = e => this._pointerEvent && ("pen" === e.pointerType || "touch" === e.pointerType),
                            ...
                            i = t => { e(t) && (this.touchDeltaX = t.clientX - this.touchStartX), this._handleSwipe(), "hover" === this._config.pause && (this.pause(), this.touchTimeout && clearTimeout(this.touchTimeout), this.touchTimeout = setTimeout((e => this.cycle(e)), 500 + this._config.interval)) };
                    ...
                    _getItemIndex(e) { return this._items = e && e.parentNode ? At.find(".carousel-item", e.parentNode) : [], this._items.indexOf(e) }
                    _getItemByOrder(e, t) { const n = e === Lt; return Ze(this._items, t, n, this._config.wrap) }
                    ...
                    _setActiveIndicatorElement(e) {
                        if (this._indicatorsElement) {
                            ...
                            for (let t = 0; t < n.length; t++)
                                if (Number.parseInt(n[t].getAttribute("data-bs-slide-to"), 10) === this._getItemIndex(e)) { n[t].classList.add(Dt), n[t].setAttribute("aria-current", "true"); break }
                        }
                    }
                    _updateInterval() {
                    ...
                    _slide(e, t) {
                        ...
                        const p = () => { ft.trigger(this._element, Pt, { relatedTarget: r, direction: h, from: o, to: s }) };
                        if (this._element.classList.contains("slide")) {
                            r.classList.add(d), qe(r), i.classList.add(c), r.classList.add(c);
                            const e = () => { r.classList.remove(c, d), r.classList.add(Dt), i.classList.remove(Dt, d, c), this._isSliding = !1, setTimeout(p, 0) };
                            this._queueCallback(e, i, !0)
                        } else i.classList.remove(Dt), r.classList.add(Dt), this._isSliding = !1, p();
                        l && this.cycle()
                    }
                    _directionToOrder(e) { return [Ct, St].includes(e) ? Ue() ? e === St ? Tt : Lt : e === St ? Lt : Tt : e }
                    _orderToDirection(e) { return [Lt, Tt].includes(e) ? Ue() ? e === Tt ? St : Ct : e === Tt ? Ct : St : e }
                ...
                ft.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", It.dataApiClickHandler), ft.on(window, "load.bs.carousel.data-api", (() => { const e = At.find('[data-bs-ride="carousel"]'); for (let t = 0, n = e.length; t < n; t++) It.carouselInterface(e[t], It.getInstance(e[t])) })), Ke(It);
                const Nt = "collapse",
                    Wt = "bs.collapse",
                ...
                class Ut extends gt {
                    ...
                    show() {
                        ...
                        if (t.length) { const i = t.find((e => n !== e)); if (e = i ? Ut.getInstance(i) : null, e && e._isTransitioning) return }
                        if (ft.trigger(this._element, "show.bs.collapse").defaultPrevented) return;
                        t.forEach((t => { n !== t && Ut.getOrCreateInstance(t, { toggle: !1 }).hide(), e || yt.set(t, Wt, null) }));
                        ...
                        this._queueCallback((() => { this._isTransitioning = !1, this._element.classList.remove(Bt), this._element.classList.add(Xt, Vt), this._element.style[i] = "", ft.trigger(this._element, "shown.bs.collapse") }), this._element, !0), this._element.style[i] = `${this._element[o]}px`
                    }
                    hide() {
                        if (this._isTransitioning || !this._isShown()) return;
                        ...
                        this._element.style[e] = "", this._queueCallback((() => { this._isTransitioning = !1, this._element.classList.remove(Bt), this._element.classList.add(Xt), ft.trigger(this._element, "hidden.bs.collapse") }), this._element, !0)
                    }
                    _isShown(e = this._element) { return e.classList.contains(Vt) }
                    _getConfig(e) { return (e = {...Rt, ...Et.getDataAttributes(this._element), ...e }).toggle = Boolean(e.toggle), e.parent = We(e.parent), Re(Nt, e, Yt), e }
                    ...
                    _addAriaAndCollapsedClass(e, t) { e.length && e.forEach((e => { t ? e.classList.remove(qt) : e.classList.add(qt), e.setAttribute("aria-expanded", t) })) }
                    static jQueryInterface(e) {
                        return this.each((function() {
                            const t = {};
                ...
                ft.on(document, "click.bs.collapse.data-api", $t, (function(e) {
                    ...
                    const t = De(this);
                    At.find(t).forEach((e => { Ut.getOrCreateInstance(e, { toggle: !1 }).toggle() }))
                })), Ke(Ut);
                const Kt = "dropdown",
                    Qt = "Escape",
                    Gt = "Space",
                ...
                class mn extends gt {
                    ...
                    _completeHide(e) { ft.trigger(this._element, "hide.bs.dropdown", e).defaultPrevented || ("ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach((e => ft.off(e, "mouseover", Be))), this._popper && this._popper.destroy(), this._menu.classList.remove(on), this._element.classList.remove(on), this._element.setAttribute("aria-expanded", "false"), Et.removeDataAttribute(this._menu, "popper"), ft.trigger(this._element, "hidden.bs.dropdown", e)) }
                    _getConfig(e) { if (e = {...this.constructor.Default, ...Et.getDataAttributes(this._element), ...e }, Re(Kt, e, this.constructor.DefaultType), "object" == typeof e.reference && !Ne(e.reference) && "function" != typeof e.reference.getBoundingClientRect) throw new TypeError(`${Kt.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`); return e }
                    _createPopper(e) {
                    ...
                    _getMenuElement() { return At.next(this._element, sn)[0] }
                    _getPlacement() { const e = this._element.parentNode; if (e.classList.contains("dropend")) return hn; if (e.classList.contains("dropstart")) return pn; const t = "end" === getComputedStyle(this._menu).getPropertyValue("--bs-position").trim(); return e.classList.contains("dropup") ? t ? an : ln : t ? dn : cn }
                    ...
                    static getParentFromElement(e) { return ze(e) || e.parentNode }
                ...
                ft.on(document, nn, rn, mn.dataApiKeydownHandler), ft.on(document, nn, sn, mn.dataApiKeydownHandler), ft.on(document, tn, mn.clearMenus), ft.on(document, "keyup.bs.dropdown.data-api", mn.clearMenus), ft.on(document, tn, rn, (function(e) { e.preventDefault(), mn.getOrCreateInstance(this).toggle() })), Ke(mn);
                ...
                class vn {
                    ...
                    reset() { this._resetElementAttributes(this._element, "overflow"), this._resetElementAttributes(this._element, "paddingRight"), this._resetElementAttributes(yn, "paddingRight"), this._resetElementAttributes(gn, "marginRight") }
                    ...
                    _applyManipulationCallback(e, t) { Ne(e) ? t(e) : At.find(e, this._element).forEach(t) }
                ...
                class En {
                    ...
                    show(e) { this._config.isVisible ? (this._append(), this._config.isAnimated && qe(this._getElement()), this._getElement().classList.add(wn), this._emulateAnimation((() => { Qe(e) }))) : Qe(e) }
                    hide(e) { this._config.isVisible ? (this._getElement().classList.remove(wn), this._emulateAnimation((() => { this.dispose(), Qe(e) }))) : Qe(e) }
                    _getElement() {
                        if (!this._element) {
                    ...
                    _getConfig(e) { return (e = {...bn, ... "object" == typeof e ? e : {} }).rootElement = We(e.rootElement), Re(xn, e, _n), e }
                    _append() { this._isAppended || (this._config.rootElement.append(this._getElement()), ft.on(this._getElement(), jn, (() => { Qe(this._config.clickCallback) })), this._isAppended = !0) }
                    dispose() { this._isAppended && (ft.off(this._element, jn), this._element.remove(), this._isAppended = !1) }
                    _emulateAnimation(e) { Ge(e, this._getElement(), this._config.isAnimated) }
                }
                ...
                class Ln {
                    ...
                    deactivate() { this._isActive && (this._isActive = !1, ft.off(document, kn)) }
                    _handleFocusin(e) {
                    ...
                    _handleKeydown(e) { "Tab" === e.key && (this._lastTabNavDirection = e.shiftKey ? On : "forward") }
                    _getConfig(e) { return e = {...An, ... "object" == typeof e ? e : {} }, Re("focustrap", e, Mn), e }
                }
                const Tn = "modal",
                    Sn = ".bs.modal",
                    Cn = "Escape",
                    ...
                    Xn = "modal-static";
                class Bn extends gt {
                    constructor(e, t) { super(e), this._config = this._getConfig(t), this._dialog = At.findOne(".modal-dialog", this._element), this._backdrop = this._initializeBackDrop(), this._focustrap = this._initializeFocusTrap(), this._isShown = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1, this._scrollBar = new vn }
                    ...
                    _initializeBackDrop() { return new En({ isVisible: Boolean(this._config.backdrop), isAnimated: this._isAnimated() }) }
                    _initializeFocusTrap() { return new Ln({ trapElement: this._element }) }
                    _getConfig(e) { return e = {...Hn, ...Et.getDataAttributes(this._element), ... "object" == typeof e ? e : {} }, Re(Tn, e, Pn), e }
                    _showElement(e) {
                        ...
                        this._queueCallback((() => { this._config.focus && this._focustrap.activate(), this._isTransitioning = !1, ft.trigger(this._element, "shown.bs.modal", { relatedTarget: e }) }), this._dialog, t)
                    }
                    _setEscapeEvent() { this._isShown ? ft.on(this._element, Wn, (e => { this._config.keyboard && e.key === Cn ? (e.preventDefault(), this.hide()) : this._config.keyboard || e.key !== Cn || this._triggerBackdropTransition() })) : ft.off(this._element, Wn) }
                    _setResizeEvent() { this._isShown ? ft.on(window, In, (() => this._adjustDialog())) : ft.off(window, In) }
                    _hideModal() { this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._isTransitioning = !1, this._backdrop.hide((() => { document.body.classList.remove(Yn), this._resetAdjustments(), this._scrollBar.reset(), ft.trigger(this._element, Dn) })) }
                    _showBackdrop(e) { ft.on(this._element, Nn, (e => { this._ignoreBackdropClick ? this._ignoreBackdropClick = !1 : e.target === e.currentTarget && (!0 === this._config.backdrop ? this.hide() : "static" === this._config.backdrop && this._triggerBackdropTransition()) })), this._backdrop.show(e) }
                    _isAnimated() { return this._element.classList.contains("fade") }
                    _triggerBackdropTransition() { if (ft.trigger(this._element, "hidePrevented.bs.modal").defaultPrevented) return; const { classList: e, scrollHeight: t, style: n } = this._element, i = t > document.documentElement.clientHeight;!i && "hidden" === n.overflowY || e.contains(Xn) || (i || (n.overflowY = "hidden"), e.add(Xn), this._queueCallback((() => { e.remove(Xn), i || this._queueCallback((() => { n.overflowY = "" }), this._dialog) }), this._dialog), this._element.focus()) }
                    _adjustDialog() {
                ...
                ft.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', (function(e) {
                    const t = ze(this);
                    ["A", "AREA"].includes(this.tagName) && e.preventDefault(), ft.one(t, zn, (e => { e.defaultPrevented || ft.one(t, Dn, (() => { Ye(this) && this.focus() })) }));
                ...
                class Gn extends gt {
                    ...
                    show(e) {
                        ...
                        this._queueCallback((() => { this._config.scroll || this._focustrap.activate(), ft.trigger(this._element, "shown.bs.offcanvas", { relatedTarget: e }) }), this._element, !0)
                    }
                    hide() {
                        if (!this._isShown) return;
                        ...
                        this._queueCallback((() => { this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._element.style.visibility = "hidden", this._config.scroll || (new vn).reset(), ft.trigger(this._element, Qn) }), this._element, !0)
                    }
                    dispose() { this._backdrop.dispose(), this._focustrap.deactivate(), super.dispose() }
                    _getConfig(e) { return e = {...Fn, ...Et.getDataAttributes(this._element), ... "object" == typeof e ? e : {} }, Re(qn, e, $n), e }
                    _initializeBackDrop() { return new En({ className: "offcanvas-backdrop", isVisible: this._config.backdrop, isAnimated: !0, rootElement: this._element.parentNode, clickCallback: () => this.hide() }) }
                    _initializeFocusTrap() { return new Ln({ trapElement: this._element }) }
                    _addEventListeners() { ft.on(this._element, "keydown.dismiss.bs.offcanvas", (e => { this._config.keyboard && "Escape" === e.key && this.hide() })) }
                    static jQueryInterface(e) {
                        return this.each((function() {
                ...
                ft.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', (function(e) {
                    ...
                    ft.one(t, Qn, (() => { Ye(this) && this.focus() }));
                ...
                function ii(e, t, n) {
                    ...
                    for (let e = 0, n = o.length; e < n; e++) {
                        ...
                        if (!Object.keys(t).includes(i)) { n.remove(); continue }
                        const r = [].concat(...n.attributes),
                            s = [].concat(t["*"] || [], t[i] || []);
                        r.forEach((e => { ti(e, s) || n.removeAttribute(e.nodeName) }))
                    }
                ...
                class bi extends gt {
                    ...
                    dispose() { clearTimeout(this._timeout), ft.off(this._element.closest(mi), yi, this._hideModalHandler), this.tip && this.tip.remove(), this._disposePopper(), super.dispose() }
                    show() {
                        ...
                        a && i.classList.add(...a.split(" ")), "ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach((e => { ft.on(e, "mouseover", Be) }));
                    ...
                    hide() {
                        ...
                        this._queueCallback((() => { this._isWithActiveTrigger() || (this._hoverState !== pi && e.remove(), this._cleanTipClass(), this._element.removeAttribute("aria-describedby"), ft.trigger(this._element, this.constructor.Event.HIDDEN), this._disposePopper()) }), this.tip, t), this._hoverState = ""
                    }
                    ...
                    setContent(e) { this._sanitizeAndSetContent(e, this.getTitle(), fi) }
                    _sanitizeAndSetContent(e, t, n) {
                        const i = At.findOne(n, e);
                        t || !i ? this.setElementContent(i, t) : i.remove()
                    }
                    setElementContent(e, t) { if (null !== e) return Ne(t) ? (t = We(t), void(this._config.html ? t.parentNode !== e && (e.innerHTML = "", e.append(t)) : e.textContent = t.textContent)) : void(this._config.html ? (this._config.sanitize && (t = ii(t, this._config.allowList, this._config.sanitizeFn)), e.innerHTML = t) : e.textContent = t) }
                    ...
                    _getAttachment(e) { return li[e.toUpperCase()] }
                    _setListeners() {
                        ...
                        })), this._hideModalHandler = () => { this._element && this.hide() }, ft.on(this._element.closest(mi), yi, this._hideModalHandler), this._config.selector ? this._config = {...this._config, trigger: "manual", selector: "" } : this._fixTitle()
                    }
                    _fixTitle() {
                    ...
                    _getConfig(e) { const t = Et.getDataAttributes(this._element); return Object.keys(t).forEach((e => { ri.has(e) && delete t[e] })), (e = {...this.constructor.Default, ...t, ... "object" == typeof e && e ? e : {} }).container = !1 === e.container ? document.body : We(e.container), "number" == typeof e.delay && (e.delay = { show: e.delay, hide: e.delay }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), Re(oi, e, this.constructor.DefaultType), e.sanitize && (e.template = ii(e.template, e.allowList, e.sanitizeFn)), e }
                ...
                Ke(bi);
                const _i = {...bi.Default, placement: "right", offset: [0, 8], trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' },
                ...
                const Ei = "scrollspy",
                    ...
                    Ci = "position";
                class Hi extends gt {
                    constructor(e, t) { super(e), this._scrollElement = "BODY" === this._element.tagName ? window : this._element, this._config = this._getConfig(t), this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, ft.on(this._scrollElement, "scroll.bs.scrollspy", (() => this._process())), this.refresh(), this._process() }
                    ...
                    refresh() {
                        ...
                        At.find(Si, this._config.target).map((e => {
                            ...
                            if (o) { const e = o.getBoundingClientRect(); if (e.width || e.height) return [Et[t](o).top + n, i] }
                            return null
                        })).filter((e => e)).sort(((e, t) => e[0] - t[0])).forEach((e => { this._offsets.push(e[0]), this._targets.push(e[1]) }))
                    }
                    dispose() { ft.off(this._scrollElement, Ai), super.dispose() }
                    _getConfig(e) { return (e = {...Mi, ...Et.getDataAttributes(this._element), ... "object" == typeof e && e ? e : {} }).target = We(e.target) || document.documentElement, Re(Ei, e, ki), e }
                    ...
                    _activate(e) {
                        ...
                        n.classList.add(Li), n.classList.contains(Oi) ? At.findOne(".dropdown-toggle", n.closest(".dropdown")).classList.add(Li) : At.parents(n, ".nav, .list-group").forEach((e => { At.prev(e, ".nav-link, .list-group-item").forEach((e => e.classList.add(Li))), At.prev(e, ".nav-item").forEach((e => { At.children(e, Ti).forEach((e => e.classList.add(Li))) })) })), ft.trigger(this._scrollElement, "activate.bs.scrollspy", { relatedTarget: e })
                    }
                    _clear() { At.find(Si, this._config.target).filter((e => e.classList.contains(Li))).forEach((e => e.classList.remove(Li))) }
                    static jQueryInterface(e) {
                        return this.each((function() {
                ...
                ft.on(window, "load.bs.scrollspy.data-api", (() => { At.find('[data-bs-spy="scroll"]').forEach((e => new Hi(e))) })), Ke(Hi);
                const Pi = "active",
                    Di = "fade",
                    zi = "show",
                    Ii = ".active",
                ...
                class Wi extends gt {
                    ...
                    show() {
                        ...
                        const o = () => { ft.trigger(e, "hidden.bs.tab", { relatedTarget: this._element }), ft.trigger(this._element, "shown.bs.tab", { relatedTarget: e }) };
                ...
                class Fi extends gt {
                    ...
                    show() {
                        ...
                        this._element.classList.remove(Yi), qe(this._element), this._element.classList.add(Vi), this._element.classList.add(Xi), this._queueCallback((() => { this._element.classList.remove(Xi), ft.trigger(this._element, "shown.bs.toast"), this._maybeScheduleHide() }), this._element, this._config.animation)
                    }
                    hide() {
                        if (!this._element.classList.contains(Vi)) return;
                        if (ft.trigger(this._element, "hide.bs.toast").defaultPrevented) return;
                        this._element.classList.add(Xi), this._queueCallback((() => { this._element.classList.add(Yi), this._element.classList.remove(Xi), this._element.classList.remove(Vi), ft.trigger(this._element, "hidden.bs.toast") }), this._element, this._config.animation)
                    }
                    dispose() { this._clearTimeout(), this._element.classList.contains(Vi) && this._element.classList.remove(Vi), super.dispose() }
                    _getConfig(e) { return e = {...qi, ...Et.getDataAttributes(this._element), ... "object" == typeof e && e ? e : {} }, Re(Ri, e, this.constructor.DefaultType), e }
                    ...
                    _setListeners() { ft.on(this._element, "mouseover.bs.toast", (e => this._onInteraction(e, !0))), ft.on(this._element, "mouseout.bs.toast", (e => this._onInteraction(e, !1))), ft.on(this._element, "focusin.bs.toast", (e => this._onInteraction(e, !0))), ft.on(this._element, "focusout.bs.toast", (e => this._onInteraction(e, !1))) }
            ...
            8508: function(e) {
                ...
                "undefined" != typeof self && self, t = function() {
                    return function(e) {
                        ...
                        function n(i) { if (t[i]) return t[i].exports; var o = t[i] = { i, l: !1, exports: {} }; return e[i].call(o.exports, o, o.exports, n), o.l = !0, o.exports }
                        ...
                        "./node_modules/core-js/internals/a-function.js": function(e, t) { e.exports = function(e) { if ("function" != typeof e) throw TypeError(String(e) + " is not a function"); return e } },
                            ...
                            e.exports = function(e) {
                                return function(t, n, s) {
                                    ...
                                    if (e && n != n) {
                                        ...
                                        for (; c > d; d++)
                                            if ((e || d in a) && a[d] === n) return e || d || 0; return !e && -1
                                }
                            }
                        },
                        ...
                        "./node_modules/core-js/internals/create-iterator-constructor.js": function(e, t, n) {
                            ...
                            e.exports = function(e, t, n) { var c = t + " Iterator"; return e.prototype = o(i, { next: r(1, n) }), s(e, c, !1, !0), l[c] = a, e }
                        },
                        "./node_modules/core-js/internals/create-property-descriptor.js": function(e, t) { e.exports = function(e, t) { return { enumerable: !(1 & e), configurable: !(2 & e), writable: !(4 & e), value: t } } },
                        ...
                        "./node_modules/core-js/internals/define-iterator.js": function(e, t, n) {
                            ...
                            e.exports = function(e, t, n, d, u, x, w) {
                                ...
                                if (C && (j = r(C.call(new e)), f !== Object.prototype && j.next && (h || r(j) === f || (s ? s(j, f) : "function" != typeof j[y] && a(j, y, _)), l(j, k, !0, !0), h && (p[k] = _))), u == v && T && T.name !== v && (O = !0, S = function() { return T.call(this) }), h && !w || L[y] === S || a(L, y, S), p[t] = S, u)
                                    if (E = { values: M(v), keys: x ? S : M(g), entries: M(b) }, w)
                        ...
                        "./node_modules/core-js/internals/internal-state.js": function(e, t, n) {
                            ...
                            if (s) {
                                var f = new u,
                                    ...
                                    y = f.has,
                                    g = f.set;
                                i = function(e, t) { return g.call(f, e, t), t }, o = function(e) { return m.call(f, e) || {} }, r = function(e) { return y.call(f, e) }
                            } else {
                                var v = h("state");
                                p[v] = !0, i = function(e, t) { return c(e, v, t), t }, o = function(e) { return d(e, v) ? e[v] : {} }, r = function(e) { return d(e, v) }
                            }
                            e.exports = { set: i, get: o, has: r, enforce: function(e) { return r(e) ? o(e) : i(e, {}) }, getterFor: function(e) { return function(t) { var n; if (!a(t) || (n = o(t)).type !== e) throw TypeError("Incompatible receiver, " + e + " required"); return n } } }
                        },
                        ...
                        "./node_modules/core-js/internals/is-forced.js": function(e, t, n) {
                            var i = n("./node_modules/core-js/internals/fails.js"),
                                o = /#|\.prototype\./,
                                r = function(e, t) { var n = l[s(e)]; return n == c || n != a && ("function" == typeof t ? i(t) : !!t) },
                        ...
                        "./node_modules/core-js/internals/iterators-core.js": function(e, t, n) {
                            ...
                            var i, o, r, s = n("./node_modules/core-js/internals/object-get-prototype-of.js"),
                                ...
                                h = c("iterator"),
                                p = !1;
                            [].keys && ("next" in (r = [].keys()) ? (o = s(s(r))) !== Object.prototype && (i = o) : p = !0), null == i && (i = {}), d || a(i, h) || l(i, h, (function() { return this })), e.exports = { IteratorPrototype: i, BUGGY_SAFARI_ITERATORS: p }
                        },
                        ...
                        "./node_modules/core-js/internals/object-create.js": function(e, t, n) {
                            ...
                            e.exports = Object.create || function(e, t) { var n; return null !== e ? (d.prototype = i(e), n = new d, d.prototype = null, n[c] = e) : n = h(), void 0 === t ? n : o(n, t) }, s[c] = !0
                        },
                        "./node_modules/core-js/internals/object-define-properties.js": function(e, t, n) {
                            ...
                            e.exports = i ? Object.defineProperties : function(e, t) { r(e); for (var n, i = s(t), l = i.length, a = 0; l > a;) o.f(e, n = i[a++], t[n]); return e }
                        },
                        "./node_modules/core-js/internals/object-define-property.js": function(e, t, n) {
                            ...
                            t.f = i ? l : function(e, t, n) {
                                if (r(e), t = s(t, !0), r(n), o) try { return l(e, t, n) } catch (e) {}
                        ...
                        "./node_modules/core-js/internals/object-get-own-property-descriptor.js": function(e, t, n) {
                            ...
                            t.f = i ? d : function(e, t) {
                                if (e = s(e), t = l(t, !0), c) try { return d(e, t) } catch (e) {}
                        ...
                        "./node_modules/core-js/internals/object-get-prototype-of.js": function(e, t, n) {
                            var i = n("./node_modules/core-js/internals/has.js"),
                                ...
                                l = r("IE_PROTO"),
                                a = Object.prototype;
                            e.exports = s ? Object.getPrototypeOf : function(e) { return e = o(e), i(e, l) ? e[l] : "function" == typeof e.constructor && e instanceof e.constructor ? e.constructor.prototype : e instanceof Object ? a : null }
                        },
                        ...
                        "./node_modules/core-js/internals/redefine.js": function(e, t, n) {
                            ...
                            o("inspectSource", (function(e) { return a.call(e) })), (e.exports = function(e, t, n, o) {
                                var a = !!o && !!o.unsafe,
                                    c = !!o && !!o.enumerable,
                                    d = !!o && !!o.noTargetGet;
                            ...
                            })(Function.prototype, "toString", (function() { return "function" == typeof this && d(this).source || a.call(this) }))
                        },
                        "./node_modules/core-js/internals/require-object-coercible.js": function(e, t) { e.exports = function(e) { if (null == e) throw TypeError("Can't call method on " + e); return e } },
                        ...
                        "./node_modules/core-js/internals/shared.js": function(e, t, n) {
                            var i = n("./node_modules/core-js/internals/global.js"),
                                ...
                                l = i[s] || o(s, {});
                            (e.exports = function(e, t) { return l[e] || (l[e] = void 0 !== t ? t : {}) })("versions", []).push({ version: "3.1.3", mode: r ? "pure" : "global", copyright: "© 2019 Denis Pushkarev (zloirock.ru)" })
                        },
                        ...
                        "./node_modules/core-js/internals/well-known-symbol.js": function(e, t, n) {
                            var i = n("./node_modules/core-js/internals/global.js"),
                                ...
                                l = i.Symbol,
                                a = o("wks");
                            e.exports = function(e) { return a[e] || (a[e] = s && l[e] || (s ? l : r)("Symbol." + e)) }
                        },
                        "./node_modules/core-js/modules/es.array.from.js": function(e, t, n) {
                            var i = n("./node_modules/core-js/internals/export.js"),
                                o = n("./node_modules/core-js/internals/array-from.js");
                            i({ target: "Array", stat: !0, forced: !n("./node_modules/core-js/internals/check-correctness-of-iteration.js")((function(e) { Array.from(e) })) }, { from: o })
                        },
                        "./node_modules/core-js/modules/es.string.iterator.js": function(e, t, n) {
                            ...
                            var i = n("./node_modules/core-js/internals/string-at.js"),
                                ...
                                l = o.set,
                                a = o.getterFor(s);
                            r(String, "String", (function(e) { l(this, { type: s, string: String(e), index: 0 }) }), (function() {
                                var e, t = a(this),
                                    n = t.string,
                                    o = t.index;
                        ...
                        "./src/default-attrs.json": function(e) { e.exports = { xmlns: "http://www.w3.org/2000/svg", width: 24, height: 24, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": 2, "stroke-linecap": "round", "stroke-linejoin": "round" } },
                        "./src/icon.js": function(e, t, n) {
                            ...
                            function d(e) { return Object.keys(e).map((function(t) { return t + '="' + e[t] + '"' })).join(" ") }
                            t.default = c
                        },
            ...
            5225: function(e) {
                e.exports = function() {
                    ...
                    function r(e, t) { if (!x) throw new Error("No element matching method supported"); return x.call(e, t) }

                    function s(e) { e.remove ? e.remove() : e.parentNode && e.parentNode.removeChild(e) }

                    function l(e, t) { return Array.prototype.filter.call(e.children, (function(e) { return r(e, t) })) }
                    ...
                    function c(e, t) { j[t] = setTimeout((function() { return e.isAlive && e.element.classList.remove(w.state.scrolling(t)) }), e.settings.scrollingThreshold) }

                    function d(e, t) { a(e, t), c(e, t) }

                    function h(e) { if ("function" == typeof window.CustomEvent) return new CustomEvent(e); var t = document.createEvent("CustomEvent"); return t.initCustomEvent(e, !1, !1, void 0), t }
                    ...
                    function m(e) { return r(e, "input,[contenteditable]") || r(e, "select,[contenteditable]") || r(e, "textarea,[contenteditable]") || r(e, "button,[contenteditable]") }

                    function y(e) { var t = n(e); return f(t.width) + f(t.paddingLeft) + f(t.paddingRight) + f(t.borderLeftWidth) + f(t.borderRightWidth) }
                    ...
                    function _(e, t) {
                        function n(t) { t.touches && t.touches[0] && (t[l] = t.touches[0].pageY), y[u] = v + _ * (t[l] - b), a(e, f), g(e), t.stopPropagation(), t.type.startsWith("touch") && 1 < t.changedTouches.length && t.preventDefault() }

                        function i() { c(e, f), e[m].classList.remove(w.state.clicking), e.event.unbind(e.ownerDocument, "mousemove", n) }

                        function o(t, o) { v = y[u], o && t.touches && (t[l] = t.touches[0].pageY), b = t[l], _ = (e[s] - e[r]) / (e[d] - e[p]), o ? e.event.bind(e.ownerDocument, "touchmove", n) : (e.event.bind(e.ownerDocument, "mousemove", n), e.event.once(e.ownerDocument, "mouseup", i), t.preventDefault()), e[m].classList.add(w.state.clicking), t.stopPropagation() }
                        var r = t[0],
                            s = t[1],
                            l = t[2],
                            d = t[3],
                            ...
                            b = null,
                            _ = null;
                        e.event.bind(e[h], "mousedown", (function(e) { o(e) })), e.event.bind(e[h], "touchstart", (function(e) { o(e, !0) }))
                    }
                    var x = "undefined" != typeof Element && (Element.prototype.matches || Element.prototype.webkitMatchesSelector || Element.prototype.mozMatchesSelector || Element.prototype.msMatchesSelector),
                        w = { main: "ps", rtl: "ps__rtl", element: { thumb: function(e) { return "ps__thumb-" + e }, rail: function(e) { return "ps__rail-" + e }, consuming: "ps__child--consume" }, state: { focus: "ps--focus", clicking: "ps--clicking", active: function(e) { return "ps--active-" + e }, scrolling: function(e) { return "ps--scrolling-" + e } } },
                        j = { x: null, y: null },
                        E = function(e) { this.element = e, this.handlers = {} },
                        A = { isEmpty: { configurable: !0 } };
                    E.prototype.bind = function(e, t) { void 0 === this.handlers[e] && (this.handlers[e] = []), this.handlers[e].push(t), this.element.addEventListener(e, t, !1) }, E.prototype.unbind = function(e, t) {
                        var n = this;
                        this.handlers[e] = this.handlers[e].filter((function(i) { return !(!t || i === t) || (n.element.removeEventListener(e, i, !1), !1) }))
                    }, E.prototype.unbindAll = function() { for (var e in this.handlers) this.unbind(e) }, A.isEmpty.get = function() { var e = this; return Object.keys(this.handlers).every((function(t) { return 0 === e.handlers[t].length })) }, Object.defineProperties(E.prototype, A);
                    var M = function() { this.eventElements = [] };
                    M.prototype.eventElement = function(e) { var t = this.eventElements.filter((function(t) { return t.element === e }))[0]; return t || (t = new E(e), this.eventElements.push(t)), t }, M.prototype.bind = function(e, t, n) { this.eventElement(e).bind(t, n) }, M.prototype.unbind = function(e, t, n) {
                        var i = this.eventElement(e);
                        i.unbind(t, n), i.isEmpty && this.eventElements.splice(this.eventElements.indexOf(i), 1)
                    }, M.prototype.unbindAll = function() { this.eventElements.forEach((function(e) { return e.unbindAll() })), this.eventElements = [] }, M.prototype.once = function(e, t, n) {
                        var i = this.eventElement(e),
                    ...
                    var k = { isWebKit: "undefined" != typeof document && "WebkitAppearance" in document.documentElement.style, supportsTouch: "undefined" != typeof window && ("ontouchstart" in window || "maxTouchPoints" in window.navigator && 0 < window.navigator.maxTouchPoints || window.DocumentTouch && document instanceof window.DocumentTouch), supportsIePointer: "undefined" != typeof navigator && navigator.msMaxTouchPoints, isChrome: "undefined" != typeof navigator && /Chrome/i.test(navigator && navigator.userAgent) },
                        O = function() { return { handlers: ["click-rail", "drag-thumb", "keyboard", "wheel", "touch"], maxScrollbarLength: null, minScrollbarLength: null, scrollingThreshold: 1e3, scrollXMarginOffset: 0, scrollYMarginOffset: 0, suppressScrollX: !1, suppressScrollY: !1, swipeEasing: !0, useBothWheelAxes: !1, wheelPropagation: !0, wheelSpeed: 1 } },
                        L = {
                            ...
                            "drag-thumb": function(e) { _(e, ["containerWidth", "contentWidth", "pageX", "railXWidth", "scrollbarX", "scrollbarXWidth", "scrollLeft", "x", "scrollbarXRail"]), _(e, ["containerHeight", "contentHeight", "pageY", "railYHeight", "scrollbarY", "scrollbarYHeight", "scrollTop", "y", "scrollbarYRail"]) },
                            keyboard: function(e) {
                                function n(n, o) { var r = t(i.scrollTop); if (0 === n) { if (!e.scrollbarYActive) return !1; if (0 === r && 0 < o || r >= e.contentHeight - e.containerHeight && 0 > o) return !e.settings.wheelPropagation } var s = i.scrollLeft; if (0 === o) { if (!e.scrollbarXActive) return !1; if (0 === s && 0 > n || s >= e.contentWidth - e.containerWidth && 0 < n) return !e.settings.wheelPropagation } return !0 }
                                var i = e.element,
                                    o = function() { return r(i, ":hover") },
                                    s = function() { return r(e.scrollbarX, ":focus") || r(e.scrollbarY, ":focus") };
                            ...
                            touch: function(i) {
                                function o(n, o) {
                                    var r = t(p.scrollTop),
                                        ...
                                        l = e(n),
                                        a = e(o);
                                    if (a > l) { if (0 > o && r === i.contentHeight - i.containerHeight || 0 < o && 0 === r) return 0 === window.scrollY && 0 < o && k.isChrome } else if (l > a && (0 > n && s === i.contentWidth - i.containerWidth || 0 < n && 0 === s)) return !0;
                                    return !0
                                }

                                function r(e, t) { p.scrollTop -= t, p.scrollLeft -= e, g(i) }
                                ...
                                function h() { i.settings.swipeEasing && (clearInterval(y), y = setInterval((function() { return i.isInitialized ? void clearInterval(y) : m.x || m.y ? .01 > e(m.x) && .01 > e(m.y) ? void clearInterval(y) : i.element ? (r(30 * m.x, 30 * m.y), m.x *= .8, void(m.y *= .8)) : void clearInterval(y) : void clearInterval(y) }), 10)) }
                        ...
                        T = function(e, r) {
                            ...
                            var a = function() { return e.classList.add(w.state.focus) },
                            ...
                            this.scrollbarXBottom = parseInt(d.bottom, 10), isNaN(this.scrollbarXBottom) ? (this.isScrollbarXUsingBottom = !1, this.scrollbarXTop = f(d.top)) : this.isScrollbarXUsingBottom = !0, this.railBorderXWidth = f(d.borderLeftWidth) + f(d.borderRightWidth), i(this.scrollbarXRail, { display: "block" }), this.railXMarginWidth = f(d.marginLeft) + f(d.marginRight), i(this.scrollbarXRail, { display: "" }), this.railXWidth = null, this.railXRatio = null, this.scrollbarYRail = o(w.element.rail("y")), e.appendChild(this.scrollbarYRail), this.scrollbarY = o(w.element.thumb("y")), this.scrollbarYRail.appendChild(this.scrollbarY), this.scrollbarY.setAttribute("tabindex", 0), this.event.bind(this.scrollbarY, "focus", a), this.event.bind(this.scrollbarY, "blur", c), this.scrollbarYActive = null, this.scrollbarYHeight = null, this.scrollbarYTop = null;
    ...
    function i(e) { var o = n[e]; if (void 0 !== o) return o.exports; var r = n[e] = { exports: {} }; return t[e].call(r.exports, r, r.exports, i), r.exports }
    i.m = t, e = [], i.O = (t, n, o, r) => {
        if (!n) {
            var s = 1 / 0;
        ...
        var t = (t, n) => {
                var o, r, [s, l, a] = n,
                    c = 0;
                if (s.some((t => 0 !== e[t]))) { for (o in l) i.o(l, o) && (i.m[o] = l[o]); if (a) var d = a(i) }
...
function copiarPortapapeles(valorCopiar) {

  var portapapeles = $("<textarea>");

  portapapeles.val(valorCopiar);

  $("body").append(portapapeles);
...
$(function() {
    ...
    const alertaPermisoTransferencia = Swal.mixin({
        toast: true,
        position: 'top-end',
    ...
    $('.sidebar-item:not(.has-sub) a').click(function(propiedadesEvento) {

        if (propiedadesEvento.currentTarget.href.includes('transferencias') && !datosUsuario.realizaTransferencia) {

            propiedadesEvento.preventDefault();

            alertaPermisoTransferencia.fire({
                icon: 'error',
                title: '¡No tienes permiso para realizar transferencias!'
            })

        }

        if (propiedadesEvento.currentTarget.href.includes('variablesFinancieras') && datosUsuario.directivo == 'USUARIO') {

            propiedadesEvento.preventDefault();

            alertaPermisoTransferencia.fire({
                icon: 'error',
                title: '¡No tienes permiso para visualizar las variables financieras!'
            })
